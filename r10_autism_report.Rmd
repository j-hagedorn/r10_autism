...
- *Days on waitlist*: The number of days that the individual has been without a BPOS.
- *Percent days covered*: The number of days between the first and last date that the person received services while waiting for a BPOS, as a percentage of the total number of days without a BPOS.
- *Total Number of encounters*: The total number of encounters, for any type of service, that the individual received while without a BPOS.
