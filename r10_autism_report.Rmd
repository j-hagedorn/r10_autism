...
- *Waiver enrollment* reports generated from the MDHHS WSA system.  Specifically, it uses the output from the WSA *"All Cases All Data"* report and the *"IPOS Data Report"*.
...
- *Number of encounters:* The total count of service encounters received.  This is 
