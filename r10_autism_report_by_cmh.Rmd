...
<h4>This *full detail* report was generated for `r paste0(params$cmh)` on `r Sys.Date()` using data from `r min(svs$FROM_DATE, na.rm = T)` - `r max(svs$FROM_DATE, na.rm = T)`</h4>
