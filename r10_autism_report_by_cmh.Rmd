...
As an initial summary, we look at the percent of enrollees, but who do not have an Individualized Bahavioral Plan of Service (IPOS).
...
wsa_tbl %>%
  datatable(
    rownames = FALSE,
    colnames = c('Regional Total','Enrollees','Waitlisted Enrollees','Pct of Waitlisted Enrollees'),
    caption = 'Percentage of enrollees without BPOS, by CMHSP',
...
# Non-ABA services for Waitlisted enrollees
...
- *Encounters per month*: A trendline of the number of encounters the individual received per month during the time they have been on the waitlist.
- *Services provided*: A list of all services which appear in the encounter data for the individual from the time that they enrolled in the Autism Waiver.
- *Days on waitlist*: The number of days that the individual has been on the waitlist.
- *Percent days covered*: The number of days between the first and last date that the person received services while on the waitlist, as a percentage of the total number of days on the waitlist.
- *Total Number of encounters*: The total number of encounters, for any type of service, that the individual received while on the waitlist.
...
dt <- t3 %>%
  ...
  select(-autism_waiver_svs) %>%
  datatable(
    data.table(),
    caption = "Non-ABA Services provided to Waitlisted Enrollees",
    rownames = FALSE,
    colnames = c('WSA ID','Encounters per month',
                 'CMHSP','Services provided',
                 'Days on waitlist','Percent days covered',
...
dt <- t3 %>%
  ...
  datatable(
    data.table(),
    caption = "ABA-inclusive Services provided to Waitlisted Enrollees",
    rownames = FALSE,
    colnames = c('WSA ID','Encounters per month',
                 'CMHSP','Services provided',
                 'Days on waitlist','Percent days covered',
